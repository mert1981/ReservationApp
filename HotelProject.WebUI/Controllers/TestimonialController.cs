...
namespace HotelProject.WebUI.Controllers
{
    public class TestimonialController : Controller
    {
        ...
        public async Task<IActionResult> AddTestimonial(TestimonialViewModel model)
        {
            ...
            var responseMessage = await client.PostAsync("http://localhost:5287/api/Testimonial/", content);
        ...
        public async Task<IActionResult> UpdateStaff(TestimonialViewModel model)
        {
            ...
            StringContent content = new StringContent(jsonData, Encoding.UTF8, "application/json");
            var responseMessage = await client.PutAsync("http://localhost:5287/api/Testimonial/", content);
            if (responseMessage.IsSuccessStatusCode)
            {
                return RedirectToAction("Index");
            }
